...
import { createDocument } from "@/app/actions/documentActions"; // Updated function name
...
export default function AddDocument() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      await createDocument(formData); // Updated function name
  ...
  return (
    <div className="grid gap-4">
      <ActionModal
        title="Add Document"
        desc="Fill in the details to add a new document."
        open={open}
        setOpen={setOpen}
        trigger={
