...
function AboutUs() {
    return (<div>
     ...
     alt="Motor Vehicle Mechanics Production Unit" fill style={{ objectFit: "cover" }}/>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <div className="flex flex-col space-y-10 bg-white p-8 shadow-lg rounded-lg">
              ...
              <button onClick={() => (window.location.href = "/donate")} className="mt-6 bg-purple-900 text-white font-semibold px-6 py-3 rounded-lg hover:bg-purple-800">
                Donate Now
              </button>
            </div>
          </div>
