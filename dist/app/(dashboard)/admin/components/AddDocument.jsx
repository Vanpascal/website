...
const documentActions_1 = require("@/app/actions/documentActions"); // Updated function name
...
function AddDocument() {
    ...
    async function onSubmit(values) {
        ...
        if ((_a = documentInput.files) === null || _a === void 0 ? void 0 : _a.length) {
        ...
        try {
            await (0, documentActions_1.createDocument)(formData); // Updated function name
            react_toastify_1.toast.success("Document created successfully!");
        }
        catch (error) {
    ...
    return (<div className="grid gap-4">
      <ActionModal_1.default title="Add Document" desc="Fill in the details to add a new document." open={open} setOpen={setOpen} trigger={<button_1.Button className="bg-green-700 hover:bg-green-500">
            Add Document
          </button_1.Button>}>
        <form_1.Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
            ...
            <form_1.FormItem>
              ...
              <form_1.FormControl>
                <input_1.Input type="file" name="document" accept=".pdf,.doc,.docx,.txt"/>
              </form_1.FormControl>
              <form_1.FormMessage />
            </form_1.FormItem>
