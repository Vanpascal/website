...
exports.default = AddAnnouncement;
...
function AddAnnouncement() {
    ...
    async function onSubmit(values) {
        ...
        try {
            await (0, announcementActions_1.createAnnouncement)(formData);
            react_toastify_1.toast.success("Announcement created successfully!");
        }
        catch (error) {
    ...
    return (<div className="grid gap-4">
      <ActionModal_1.default title="Add Announcement" desc="Fill in the details to add a new announcement." open={open} setOpen={setOpen} trigger={<button_1.Button className="bg-green-700 hover:bg-green-500">
            Add Announcement
          </button_1.Button>}>
        <form_1.Form {...form}>
