...
const AddUser_1 = __importDefault(require("@/app/(dashboard)/admin/components/AddUser"));
...
function DataTable({ columns, data, }) {
    ...
    return (<div className="space-y-4">
      <div className="flex items-center justify-between py-4">
        <input_1.Input placeholder="Search by email..." value={(_b = (_a = table.getColumn("email")) === null || _a === void 0 ? void 0 : _a.getFilterValue()) !== null && _b !== void 0 ? _b : ""} onChange={(event) => { var _a; return (_a = table.getColumn("email")) === null || _a === void 0 ? void 0 : _a.setFilterValue(event.target.value); }} className="max-w-sm"/>
