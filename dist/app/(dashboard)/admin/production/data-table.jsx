...
const AddProduct_1 = __importDefault(require("../components/AddProduct"));
function DataTable({ columns, data, }) {
    ...
    return (<div className="space-y-4">
      <div className="flex items-center justify-between py-4">
        <input_1.Input placeholder="Search by product name..." value={(_b = (_a = table.getColumn("product_name")) === null || _a === void 0 ? void 0 : _a.getFilterValue()) !== null && _b !== void 0 ? _b : ""} onChange={(event) => { var _a; return (_a = table.getColumn("product_name")) === null || _a === void 0 ? void 0 : _a.setFilterValue(event.target.value); }} className="max-w-sm"/>

        <AddProduct_1.default />
      </div>
