...
const AddRecentUpdate_1 = __importDefault(require("../../components/AddRecentUpdate"));
function DataTable({ columns, data, }) {
    ...
    return (<div className="space-y-4">
      <div className="flex items-center justify-between py-4">
        <input_1.Input placeholder="Search by title..." value={(_b = (_a = table.getColumn("title")) === null || _a === void 0 ? void 0 : _a.getFilterValue()) !== null && _b !== void 0 ? _b : ""} onChange={(event) => { var _a; return (_a = table.getColumn("title")) === null || _a === void 0 ? void 0 : _a.setFilterValue(event.target.value); }} className="max-w-sm"/>

        <AddRecentUpdate_1.default />
      </div>
