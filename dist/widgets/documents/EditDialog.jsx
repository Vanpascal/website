...
function EditDialog({ title, desc, initialData, onConfirm, }) {
    ...
    async function onSubmit(values) {
        ...
        onConfirm(formData); // Pass FormData to the onConfirm function
    }
    return (<alert_dialog_1.AlertDialog>
      <alert_dialog_1.AlertDialogTrigger asChild>
        <button_1.Button variant="ghost" className="h-10 w-10 p-0 hover:bg-yellow-200 focus:outline-none transition-colors" title="Edit Document">
