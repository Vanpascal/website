...
function EditDialog({ title, desc, initialData, onConfirm, }) {
    ...
    return (<alert_dialog_1.AlertDialog>
      <alert_dialog_1.AlertDialogTrigger asChild>
        <button_1.Button variant="ghost" className="h-10 w-10 p-0 hover:bg-yellow-200 focus:outline-none transition-colors" title="Edit Banner">
        ...
        <form_1.Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
            <form_1.FormField control={form.control} name="title" render={({ field }) => (<form_1.FormItem>
                  ...
                  <form_1.FormControl>
                    <input_1.Input placeholder="Enter banner title" {...field}/>
                  </form_1.FormControl>
                  <form_1.FormMessage />
                </form_1.FormItem>)}/>

            <form_1.FormItem>
              <form_1.FormLabel>Image</form_1.FormLabel>
              <form_1.FormControl>
                <input_1.Input type="file" name="photo" accept="image/*" placeholder="Upload banner image"/>
              </form_1.FormControl>
              <form_1.FormMessage />
            </form_1.FormItem>
