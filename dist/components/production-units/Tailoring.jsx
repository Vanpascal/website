...
function Tailoring() {
    ...
    (0, react_1.useEffect)(() => {
        const getProducts = async () => {
            try {
                const data = await (0, productActions_1.fetchTailoringProducts)();
        ...
        const getHOD = async () => {
            var _a;
            try {
                const data = await (0, staffActions_1.fetchTailoringHOD)();
                if (data.length > 0) {
    ...
    return (<div className="bg-gray-100">
      ...
      <section className="relative">
        <div className="relative w-full h-80 md:h-[400px]">
          <image_1.default src="/images/tailoring.jpg" // Replace with the actual image path
     alt="Tailoring Production Unit" fill style={{ objectFit: "cover" }}/>
        </div>
