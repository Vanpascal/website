...
const MotorVehicleMechanics = () => {
    ...
    (0, react_1.useEffect)(() => {
        const getHOD = async () => {
            var _a;
            try {
                const data = await (0, staffActions_1.fetchMotorVehicleHOD)();
                if (data.length > 0) {
    ...
    return (<div className="bg-gray-100">
      ...
      <section className="relative">
        <div className="relative w-full h-80 md:h-[400px]">
          <image_1.default src="/images/magari.jpg" alt="Motor Vehicle Mechanics Production Unit" fill style={{ objectFit: "cover" }}/>
        </div>
        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-start lg:justify-between gap-12">
          ...
          {hod && (<div className="flex-shrink-0 text-center">
              <div className="relative w-80 h-80 mx-auto mb-6">
                <image_1.default src={hod.photo} alt={`${hod.firstname} ${hod.lastname}`} fill style={{ objectFit: "cover" }} className="rounded-lg shadow-xl"/>
              </div>
...
exports.default = MotorVehicleMechanics;
