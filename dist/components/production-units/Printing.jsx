...
const productActions_1 = require("@/app/actions/productActions"); // Adjust the import path as needed
const staffActions_1 = require("@/app/actions/staffActions"); // Adjust the import path as needed
function Printing() {
    ...
    (0, react_1.useEffect)(() => {
        const getProducts = async () => {
            try {
                const data = await (0, productActions_1.fetchPrintingProducts)();
        ...
        const getHOD = async () => {
            var _a;
            try {
                const data = await (0, staffActions_1.fetchPrintingHOD)();
                if (data.length > 0) {
                    const hodData = data[0]; // Assuming the first entry is the HOD
                    setHOD({
                        firstname: hodData.firstname,
                        lastname: hodData.lastname,
                        title: (_a = hodData.position) !== null && _a !== void 0 ? _a : "Head of Department", // Provide a default title if null
    ...
    return (<div className="bg-gray-100">
      ...
      <section className="relative">
        <div className="relative w-full h-80 md:h-[400px]">
          <image_1.default src="/images/about.jpg" // Replace with the actual image path
     alt="Printing Production Unit" fill style={{ objectFit: "cover" }}/>
        </div>
        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-start lg:justify-between gap-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md w-full lg:w-2/3">
            ...
            <div className="mt-6 flex justify-end">
              <a href="/booking" // Replace with the actual booking link
            ...
            {products.map((product) => (<div key={product.id} className="bg-white rounded-lg shadow-lg overflow-hidden">
                ...
                <div className="p-4">
                  <div className="flex items-center justify-between">
                    ...
                    <a href="/cart" // Replace with the actual cart link
