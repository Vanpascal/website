        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-3 gap-12 items-stretch">
            ...
            <div className="relative flex flex-col justify-center items-center text-center bg-white p-10 rounded-2xl shadow-lg border border-purple-100 space-y-6">
              ...
              <button onClick={() => (window.location.href = "/donate")} className="px-8 py-3 bg-gradient-to-r from-purple-900 to-purple-700 text-white font-semibold rounded-full shadow-md hover:scale-105 hover:shadow-xl transition-transform duration-300 flex items-center gap-2">
