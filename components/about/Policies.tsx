...
const policies = [
  {
    ...
    purpose:
      "To encourage and maintain environmentally friendly practices among VTCs’ staff with a purpose of contributing towards sustainable preservation of the natural environmental order.",
    guidingPolicies: [
  ...
  },
  {
    ...
    purpose:
      "To provide equal opportunity for people infected by HIV/AIDS to enjoy equal rights as those not infected and being taken care of as part of the VTCs’ community.",
    guidingPolicies: [
  ...
  },
  {
    ...
    purpose:
      "To place obligation on VTCs and their management to make sure that employees work under safe conditions and industrial safety regulations are respected.",
    guidingPolicies: [
      ...
      {policies.map((policy, index) => (
        <div key={index} className="mb-6 border-b pb-4">
          ...
          <ul className="list-disc pl-5 text-gray-600">
            {policy.guidingPolicies.map((item, i) => (
              <li key={i}>{item}</li>
            ))}
          </ul>
        </div>
