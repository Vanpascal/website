    ...
    <section className="bg-gradient-to-b from-purple-50 to-white py-16">
      <div className="container mx-auto px-6">
        <motion.h2
          ...
          className="text-4xl sm:text-5xl font-bold text-center text-purple-900 mb-12"
        >
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-8 items-center justify-items-center">
          {sponsors.map((sponsor, index) => (
            <motion.div
              ...
              className="bg-white shadow-xl rounded-xl p-6 flex flex-col items-center justify-center hover:shadow-2xl transition-shadow duration-300 w-full max-w-xs"
            >
              ...
              <a
                ...
                className="mt-3 text-purple-900 font-medium text-sm sm:text-base underline hover:text-blue-700"
              >
                Visit Website
              </a>
            </motion.div>
