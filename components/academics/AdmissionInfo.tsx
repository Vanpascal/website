          ...
          <div className="lg:w-3/4 space-y-6">
            ...
            <div className="space-y-6 text-gray-700">
              ...
              <p className="">
                ...
                <a
                  href="/programs/long-courses"
                  className="text-purple-900 font-semibold hover:underline ml-1"
                  aria-label="Long-term courses page"
                >
                ...
                <a
                  ...
                  className="text-purple-900 font-semibold hover:underline ml-1"
                  aria-label="Short-term courses page"
                >
            ...
            <CoursesSection
              ...
              description="These are courses offered for a period of three years:"
              courses={[
            ...
            <CoursesSection
              ...
              description="These are courses offered for a period of 6 months to 1 year, except for the computer course, which is offered for a minimum of 3 months:"
              courses={[
                "Plumbing and Pipe Fitting",
                "Electrical Installation",
                "Motor Vehicle Mechanics",
            ...
            <ul className="space-y-3  text-gray-700">
              <li>
                <a
                  ...
                  aria-label="About Don Bosco Iringa"
                >
                  Long Courses
                </a>
              </li>
...
// Define Props Type for CoursesSection
