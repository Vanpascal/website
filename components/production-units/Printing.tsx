...
import { fetchPrintingProducts } from "@/app/actions/productActions"; // Adjust the import path as needed
import { fetchPrintingHOD } from "@/app/actions/staffActions"; // Adjust the import path as needed
...
function Printing() {
  ...
  useEffect(() => {
    const getProducts = async () => {
      try {
        const data = await fetchPrintingProducts();
