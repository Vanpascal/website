        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {["Home", "About Us", "Our Services", "Events", "Contact Us"].map(
                (link) => (
                  <li key={link}>
                    <a
                      href="#"
          ...
          <div>
            ...
            <form className="space-y-4">
              <input
                ...
                className="w-full p-3 rounded bg-gray-800 text-gray-100 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
              <button
                type="submit"
                className="w-full py-3 bg-blue-600 hover:bg-blue-700 text-gray-100 rounded transition-all duration-200"
              >
                Subscribe
              </button>
            </form>
